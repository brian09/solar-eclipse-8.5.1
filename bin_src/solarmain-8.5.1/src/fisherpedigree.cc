...
// Sex might be unavailable for empirical pedigree
	if (Ibd_Index->test_name ("SEX", &errmsg))
	{
//	    printf ("\nSEX FOUND\n");
	    Pedigree::SexVar(1); // Use pedigree sex variable
	...
	{
//	    printf ("sex variable not in pedigree file\n");
	    Pedigree::SexVar(0); // No sex variable in pedigree
// Use MZTWIN as placeholder
...
// Just read person from current pedigree
	...
	*sex = 0;  // this unassigned variable will be blocked later
    }
